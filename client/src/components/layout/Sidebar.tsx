...
import divImage from '../../assets/inventory.png';
...
const Sidebar = () => {
  ...
  return (
    <Layout style={{height: '100vh'}}>
      ...
      >
        <div className='demo-logo-vertical' style={{backgroundImage: `url(${divImage})`,backgroundSize: 'cover', height:200,
      backgroundPosition: 'center', }}>
          <h1 style={{color: '#000080', padding: '1rem', fontSize: '1.8rem', textAlign: 'center'}}>
            WELCOME 
          </h1>
        </div>
        <Menu
