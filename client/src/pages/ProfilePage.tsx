...
import bgprofile from './auth/assets/profile1.webp';
...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      <Flex vertical style={{ minHeight: 'calc(100vh - 10rem)',backgroundImage: `url(${bgprofile})`,backgroundSize: "2500px 1800px",
